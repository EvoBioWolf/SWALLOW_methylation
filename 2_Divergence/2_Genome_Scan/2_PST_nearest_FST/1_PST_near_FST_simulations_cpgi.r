...
# --- Working Directory ---
setwd("/dss/dsslegfs01/pr53da/pr53da-dss-0034/projects/2021_SwallowRRBS/2_Divergence/1_PST/0_cpgi_pst/")

# --- Input Data ---
pst_data <- read.table("/dss/dsslegfs01/pr53da/pr53da-dss-0034/projects/2021_SwallowRRBS/2_Divergence/1_PST/0_cpgi_pst/0_pst_cpgi_c05.txt", header = TRUE)
...
write.table(final_results_gw, "/dss/dsslegfs01/pr53da/pr53da-dss-0034/projects/2021_SwallowRRBS/2_Divergence/2_Genome_Scan/2_PST_nearest_FST/2_simulation_results/1_PST_99_FST_99_1ksim_cpgi_results.txt", quote=F, row.names=F)
