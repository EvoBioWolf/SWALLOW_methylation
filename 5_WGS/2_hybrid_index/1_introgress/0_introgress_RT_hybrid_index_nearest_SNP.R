...
cpg_sites <- cpg_sites %>%
  tidyr::separate(site.id, into = c( "chr", "start", "end"), sep = "_", remove = FALSE)
...
write.table(geno_table, "/dss/dsslegfs01/pr53da/pr53da-dss-0034/projects/2021_SwallowRRBS/5_WGS/2_hybrid_index/1_introgress/1_RT_local_nearest_SNP_maf1.txt", row.names=F, quote=F)
