...
vcf <- read.vcfR("/dss/dsslegfs01/pr53da/pr53da-dss-0034/projects/2021_SwallowRRBS/5_WGS/2_hybrid_index/0_ancestry_informative/RGvcf.ancestry.informative.fst8.vcf.gz")
...
# ---- 6. Write input file ------------
out <- file("/dss/dsslegfs01/pr53da/pr53da-dss-0034/projects/2021_SwallowRRBS/5_WGS/2_hybrid_index/2_newhybrids/RG_hyb/2_empirical/RG_70_NH.txt", "w")
...
write.table(
  df_inds,
  file = "/dss/dsslegfs01/pr53da/pr53da-dss-0034/projects/2021_SwallowRRBS/5_WGS/2_hybrid_index/2_newhybrids/RG_hyb/2_empirical/RG_70_NH_individuals.txt",
  row.names = FALSE,
  col.names = FALSE,
  quote = FALSE
)
...
#ref_set <- nh_mat[c(1:5,7,9:12,60:63,65:67,69,70),]
...
#write_genepop(
#  mat  = ref_set,
#  file = "/dss/dsslegfs01/pr53da/pr53da-dss-0034/projects/2021_SwallowRRBS/5_WGS/2_hybrid_index/2_newhybrids/RG_hyb/1_simulations/RG_par_sim.txt"
#)
...
#hybriddetective::freqbasedsim_GTFreq(GenePopData = "/dss/dsslegfs01/pr53da/pr53da-dss-0034/projects/2021_SwallowRRBS/5_WGS/2_hybrid_index/2_newhybrids/RG_hyb/1_simulations/RG_par_sim.txt", pop.groups = c("PopG", "PopR"), sample.sizePure = 11, sample.sizeF1 = 12, sample.sizeF2 = 12, sample.sizeBC = 12, NumSims = 3, NumReps = 3)
...
parallelnewhybrid::parallelnh_LINUX(folder.data = "/dss/dsslegfs01/pr53da/pr53da-dss-0034/projects/2021_SwallowRRBS/5_WGS/2_hybrid_index/2_newhybrids/RG_hyb/1_simulations/", where.NH = your.NH, burnin = 20000, sweeps = 200000)

#Run again on empirical data with same parameters
#parallelnewhybrid::parallelnh_LINUX(folder.data = "/dss/dsslegfs01/pr53da/pr53da-dss-0034/projects/2021_SwallowRRBS/5_WGS/2_hybrid_index/2_newhybrids/RG_hyb/2_empirical/", where.NH = your.NH, burnin = 100000, sweeps = 200000)
