...
#Usage: for i in $(ls *_val_1_bismark_bt2_pe.CpG_merged.cov | rev | cut -c37- | rev); do sbatch -J ${i} /dss/dsslegfs01/pr53da/pr53da-dss-0034/projects/2021_SwallowRRBS/0_Pre-processing/2_bismark_filter/1_bismark.filter.merged.sh ${i}; done
