...
eigenvec <- "/dss/dsslegfs01/pr53da/pr53da-dss-0034/projects/2021_SwallowRRBS/5_WGS/1_Population_Structure/1_PCA/3_85.SM/HR.83.RDA.eigenvec"
...
prop.168.20miss.merged <- read.delim("/dss/dsslegfs01/pr53da/pr53da-dss-0034/projects/2021_SwallowRRBS/0_Pre-processing/4_methyl_calling/1_CpG_islands/168.20miss/homer.cpgi.prop.168.merged.20miss.rmlowv.rmout.txt", header=T, sep="\t")

prop.168.20miss.merged <- prop.168.20miss.merged[1:25212,]
prop.168.20miss.merged <- prop.168.20miss.merged %>% filter(!is.na(region.id))
...
```{r}
ggsave("/dss/dsslegfs01/pr53da/pr53da-dss-0034/projects/2021_SwallowRRBS/1_Population_Structure/2_RDA/Supp.Fig.island.RDA.85.20miss.png", plot = p, width = 5, height = 5.1, units = "in", dpi = 500)
